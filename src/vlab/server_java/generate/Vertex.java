...
/**
 * Created by Niqera on 12.06.2016.
 */
...
public class Vertex {
     ...
     */
    public Vertex(Integer level, Node data) {
        this();
        setData(data);
        setLevel(level);
    }
     ...
     */
    public void insertChildAt(int index, Vertex child) throws IndexOutOfBoundsException {
